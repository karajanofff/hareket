...
const items = [["Kabinet", "/admin", BarChart3], ["Video sabaqlar", "/admin/videos", Video], ["Sabaqlar", "/admin/lessons", BookOpen], ["Jol belgileri", "/admin/signs", Waypoints], ["Sorawlar", "/admin/questions", HelpCircle], ["Paydalanıwshılar", "/admin/users", Users]];
