...
export default async function AdminPage() {
  ...
  return <section className="page grid gap-6 lg:grid-cols-[260px_1fr]"><AdminSidebar /><div><h1 className="text-4xl font-black text-white">Admin panel</h1><div className="mt-8 grid gap-4 md:grid-cols-3"><StatCard title="Paydalanıwshılar" value={users} icon={Users} /><StatCard title="Video dársler" value={videos} icon={Video} /><StatCard title="Jol belgileri" value={signs} icon={Waypoints} /><StatCard title="Testler" value={questions} icon={HelpCircle} /><StatCard title="Ortasha nátiyje" value={`${avg}%`} icon={BarChart3} /></div></div></section>;
}
